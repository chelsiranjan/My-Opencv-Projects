    ...
    if results.multi_hand_landmarks:
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if index_y < 80:
                ...
                if distance < 35:
                    xp, yp = 0, 0
                    #cv2.line(img, (index_x, index_y), (middle_x, middle_y), (255, 255, 255), 10)
                    cv2.circle(img, (index_x, index_y), 18, (255, 255, 255), cv2.FILLED)
                    cv2.circle(img, (middle_x, middle_y), 18, (255, 255, 255), cv2.FILLED)
